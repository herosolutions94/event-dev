...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    Route::get('login', [AuthController::class, 'loginForm'])->name('login')->middleware('admin_logged_in');;
    Route::post('login', [AuthController::class, 'login'])->name('login')->middleware('admin_logged_in');;
    ...
    Route::middleware(['is_admin'])->group(function(){
        ...
        Route::group(['prefix' => 'players', 'as' => 'players.'], function () {
            Route::get('index', [UserController::class, 'players'])->name('players');
            Route::get('view/{id}', [UserController::class, 'view'])->name('view');
            Route::get('edit/{id}', [UserController::class, 'edit_player'])->name('edit');
            Route::post('update/{id}', [UserController::class, 'update'])->name('update');
            Route::get('delete/{id}', [UserController::class, 'delete'])->name('destroy');
        });
        Route::group(['prefix' => 'organizers', 'as' => 'organizers.'], function () {
            Route::get('index', [UserController::class, 'organizers'])->name('organizers');
            Route::get('view/{id}', [UserController::class, 'view'])->name('view');
            Route::get('delete/{id}', [UserController::class, 'delete'])->name('destroy');
            Route::get('edit/{id}', [UserController::class, 'edit_organizer'])->name('edit');
            Route::post('update/{id}', [UserController::class, 'update'])->name('update');
        });
        ...
        Route::group(['prefix' => 'affiliations', 'as' => 'affiliations.'], function () {
            ...
            Route::get('change-password', [DashboardController::class, 'updatePassword'])->name('updatePassword');
    });
